...
from app.core.dependencies import TokenUser, require_restaurant_owner
...
async def _get_owned_restaurant(restaurant_id: int, owner: TokenUser, db: AsyncSession) -> Restaurant:
