...
from app.core.dependencies import TokenUser, get_current_user, require_restaurant_owner
...
async def list_restaurants(skip: int = 0, limit: int = 20, db: AsyncSession = Depends(get_db)) -> list[Restaurant]:
