...
- [ ] **Этап 5: Telegram-бот** — notification-service на aiogram, уведомления о статусе заказа.
- [x] **Этап 6: Kubernetes локально** — minikube, Helm, автоскейлинг.
- [x] **Этап 7: CI/CD** — GitHub Actions, автоматические тесты, сборка, деплой.
- [ ] **Этап 8: AWS** — EKS, RDS, MSK, Terraform, production-ready инфраструктура.
- [ ] **Этап 9: Observability** — Prometheus, Grafana, Sentry, OpenTelemetry.
